...
class purchase_order(osv.osv):
    ...
    _columns = {
        ...
        'origin': fields.char('Source Document', size=64, track_visibility='onchange',
        ...
        'partner_ref': fields.char('Supplier Reference', track_visibility='onchange', states={'confirmed':[('readonly',True)], 'approved':[('readonly',True)],'done':[('readonly',True)]}, size=64,
        ...
        'date_order':fields.date('Order Date', required=True, track_visibility='onchange', states={'confirmed':[('readonly',True)], 'approved':[('readonly',True)]}, select=True, help="Date on which this document has been created."),
