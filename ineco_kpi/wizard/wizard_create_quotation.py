...
class inece_kpi_create_quotation(osv.osv_memory):
    
    _name = "ineco.kpi.create_quotation"
    _columns = {
    ...
    def create_wizard(self, cr, uid, ids, context=None):
        ...
        for sale_id in sale_user_ids:
            quotation_ids = self.pool.get('ineco.kpi.quotation').search(cr, uid, 
            ...
            if not quotation_ids:
                ...
                self.pool.get('ineco.kpi.quotation').create(cr, uid, new_data)
