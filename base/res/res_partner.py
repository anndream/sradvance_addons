...
class res_partner(osv.osv, format_address):
    ...
    _columns = {
        ...
        'customer': fields.boolean('Customer', help="Check this box if this contact is a customer.", track_visibility='onchange'),
        'supplier': fields.boolean('Supplier', help="Check this box if this contact is a supplier. If it's not checked, purchase people will not see it when encoding a purchase order.", track_visibility='onchange'),
        ...
        'is_company': fields.boolean('Is a Company', help="Check if the contact is a company, otherwise it is a person", track_visibility='onchange'),
