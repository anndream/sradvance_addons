...
class stock_picking_out(osv.osv):
    ...
    _columns = {
        'account_internal_no': fields.char('Internal Ref', size=64, track_visibility='onchange'),
...
class stock_picking(osv.osv):
    ...
    def _prepare_invoice_line(self, cr, uid, group, picking, move_line, invoice_id,
        ...
        return {
            ...
            'product_width': move_line.product_width or 0.0,
            'product_length': move_line.product_length or 0.0,
        }
    ...
    def action_invoice_create(self, cr, uid, ids, journal_id=False,
        ...
        for picking in self.browse(cr, uid, ids, context=context):
            ...
            if picking.partner_invoice_id:
                partner = picking.partner_invoice_id.id
            else:
