from service.http_server import reg_http_service, StaticHTTPHandler #, HttpDaemon
...
class JasperHandler(BaseHTTPRequestHandler): #netsvc.OpenERPDispatcher,
    cache = {}
...
reg_http_service(HTTPDir('/jasper/', JasperHandler), StaticHTTPHandler)
