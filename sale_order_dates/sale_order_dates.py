...
# 2015-03-29    AOY-001    Change Default Effectdate to date_confirm
...
class sale_order_dates(osv.osv):
    ...
    def _get_effective_date(self, cr, uid, ids, name, arg, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            dates_list = []
            dates_list.append(order.date_confirm)
            #AOY-001
    ...
    _columns = {
        ...
        'effective_date': fields.function(_get_effective_date, type='date', 
                                          ...
                                          string='Effective Date',help="Date on which picking is created."),
    }
